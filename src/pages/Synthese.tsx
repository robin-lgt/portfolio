    ...
    <div className="min-h-screen container mx-auto px-4 py-16">
      <div className="max-w-5xl mx-auto animate-fade-in">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-muted-foreground mb-4">
                Document récapitulatif de l'ensemble des projets réalisés durant ma formation.
              </p>
        ...
        <Card className="p-8 shadow-soft hover:shadow-hover transition-all duration-300 animate-slide-up">
          ...
          <div className="aspect-[297/210] min-h-[500px] w-full bg-background rounded-lg border-2 border-border overflow-hidden">
            <iframe
